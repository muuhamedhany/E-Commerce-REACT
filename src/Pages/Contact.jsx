...
import { FaPhone, FaEnvelope, FaClock, FaMapMarkerAlt, FaFacebook, FaInstagram, FaTwitter, FaLinkedin } from 'react-icons/fa';
        ...
        <div className="lg:w-1/2 space-y-8 mb-8 lg:mb-0">
          ...
          <div className="bg-gradient-to-r from-[var(--primary)] to-[var(--accent)] p-6 rounded-lg shadow-md">
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-white hover:text-[var(--secondary)] transition-colors duration-300"><FaFacebook className="text-3xl" /></a>
              <a href="#" className="text-white hover:text-[var(--secondary)] transition-colors duration-300"><FaInstagram className="text-3xl" /></a>
              <a href="#" className="text-white hover:text-[var(--secondary)] transition-colors duration-300"><FaTwitter className="text-3xl" /></a>
              <a href="#" className="text-white hover:text-[var(--secondary)] transition-colors duration-300"><FaLinkedin className="text-3xl" /></a>
            </div>
          </div>
        </div>
        ...
        <div className="lg:w-1/2 bg-gradient-to-r from-[var(--primary)] to-[var(--accent)] p-6 rounded-lg shadow-md">
          ...
          <form>
            <div className="mb-4">
              ...
              <input type="text" id="name" name="name" className="w-full px-4 py-3 border border-gray-300 
          rounded-[0.5rem] bg-[#495b5733]" required />
            </div>
            <div className="mb-4">
              <label htmlFor="email" className="block text-white text-sm font-bold mb-2">Email</label>
              <input type="email" id="email" name="email" className="w-full px-4 py-3 border border-gray-300 
          rounded-[0.5rem] bg-[#495b5733]" required />
            </div>
            <div className="mb-4">
              <label htmlFor="subject" className="block text-white text-sm font-bold mb-2">Subject</label>
              <input type="text" id="subject" name="subject" className="w-full px-4 py-3 border border-gray-300 
          rounded-[0.5rem] bg-[#495b5733]" required />
            </div>
            <div className="mb-4">
              <label htmlFor="message" className="block text-white text-sm font-bold mb-2">Message</label>
              <textarea id="message" name="message" rows="5" className="w-full px-4 py-3 border border-gray-300 
          rounded-[0.5rem] bg-[#495b5733]" required></textarea>
            </div>
            <button type="submit" className="secondary-button px-6 py-3 text-lg w-full">
              Send Message
            </button>
          </form>
        </div>
